...
; Following functions provided by sbcos
;Print_CR = $ output cr
;Input_Chr = $ get characte (could have chr echo, chr echo added below)
;Output  = $ ascci byte
;Print1SP = $ output a space
;Print1Byte = $ output two character hex byte
 	.include SBC.LBL
...
GETCH 	jsr SAVR
		jsr Input_Chr
		jsr Output      ; echo to display
		jmp RESR1
	
OUTCH 	jsr SAVR
		jsr Output      ; print character
		jmp RESR
...
OUTBYT 	jsr SAVR         ; spotted by Hans, was jmp
		jsr Print1Byte  ; print two character hex byte
...
FTAB 	
                .byte "00D1-00E2"
		.byte $0d, $00, $0a, $00
		.byte "2000-24a0" ; "2000-249D" ; change 2490 to 249D
